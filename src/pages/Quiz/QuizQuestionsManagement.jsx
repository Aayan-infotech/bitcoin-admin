  ...
  const fetchSections = useCallback(async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://54.236.98.193:3210/api/quiz/get-quizById/${quizId}`
      );
  ...
  const handleDeleteQuestion = async (questionId) => {
    try {
      ...
      const res = await axios.delete(
        "http://54.236.98.193:3210/api/quiz/delete-question",
        { data: { questionId } } 
      );
      if (res.data.message) {
  ...
  const saveQuestionChanges = async (data) => {
    try {
      ...
      if (editQuestion) {
        ...
        await axios.patch(
          `http://54.236.98.193:3210/api/quiz/update-question/${editQuestion._id}`,
          updatedQuestion
        );
        ...
        await axios.post(
          `http://54.236.98.193:3210/api/quiz/add-question/${quizId}`,
